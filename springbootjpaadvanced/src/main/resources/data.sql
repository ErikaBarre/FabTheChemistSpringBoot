...
insert into FAB_STUDENT (ST_ID, ST_NAME) values (20001, 'James');
insert into FAB_STUDENT (ST_ID, ST_NAME) values (20002, 'Erika');
insert into FAB_STUDENT (ST_ID, ST_NAME) values (20003, 'Joe');
insert into FAB_STUDENT (ST_ID, ST_NAME) values (20004, 'Jessie');
