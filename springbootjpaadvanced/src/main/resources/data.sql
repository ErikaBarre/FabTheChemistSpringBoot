...
insert into FAB_REVIEW (RE_ID, RE_RATING, RE_DESCRIPTION) values (40001, '4', 'Good lesson');
insert into FAB_REVIEW (RE_ID, RE_RATING, RE_DESCRIPTION) values (40002, '4','Awesomme Good lesson');
insert into FAB_REVIEW (RE_ID, RE_RATING, RE_DESCRIPTION) values (40003, '4','very Good lesson');
insert into FAB_REVIEW (RE_ID, RE_RATING, RE_DESCRIPTION) values (40004, '4','super Good lesson');
